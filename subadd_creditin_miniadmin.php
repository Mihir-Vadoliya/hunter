            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">New Credit Add</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form name="confgure" action="subcredit_addin_miniadmin.php" method="get">
                     <div class="card-body">
                        <div class="row">
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
                                 <label for="clientid" class="form-label mt-4">ADMIN NAME</label>
                                 <input type="text" class="form-control" name="uid" id="clientid" readonly="readonly" value="<?php echo "$id"; ?>" aria-describedby="clientid" required placeholder="SUB ADMIN NAME">
                                 <input type="hidden" class="form-control" name="sn" id="clientid" value="<?php echo "$sn"; ?>" aria-describedby="clientid" required placeholder="SUB ADMIN ID">
                              </div>
                           </div>
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
