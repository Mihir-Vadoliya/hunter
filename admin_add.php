                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add New Credit</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="row" name="aspnetForm" method="get" action="admin_add_credit.php" id="aspnetForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label for="clientid" class="form-label mt-4">SUPER NAME</label>
                                    ...
                                    <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label mt-4">SUPER CREDIT</label>
