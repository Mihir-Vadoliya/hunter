      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row my-2">
                 <form name="confgure" method="POST" action="panel_news.php" id="aspnetForm">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-8 col-sm-8 col-md-8 col-lg-8">
                        <div class="form-group">
                          <label for="clientid" class="form-label mt-4">Enter The News</label>
                             <input type="text" class="form-control" name="panel_news" id="panel_news"   aria-describedby="clientid"
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($con->query($sql) === TRUE) {
        header('location:panel_news.php');
        ?><script>
    
              window.location = 'panel_news.php';
              </script>
              <?php
    		exit;
    } else {
