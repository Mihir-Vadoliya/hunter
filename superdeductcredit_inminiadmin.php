...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">MaterAdmin Dashboard</h1>
                    <h5 class="tile-title">
                        <?php
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Credit Deduct</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="row" name="aspnetForm" method="get" action="miniadmin_deductsupercredit.php" id="aspnetForm">
                            <div class="card-body">
                                <div class="row">
