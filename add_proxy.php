...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark"> Proxy Add/Delete Dashboard</h1>
      ...
      <div class="container-fluid">
               ...
               <div class="card card-primary">
                  ...
                  <div class="card-body">
                     <form class="row g-3" method="post" action="add_user_ip.php" onsubmit="return panValidation();" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                           <label for="inputCity" class="form-label">Add IP</label>
                        ...
                        <div class="col-md-3" style="display:none;">
                           <label for="inputsuperID" class="form-label visually-hidden">Add IP</label>
                           <input type="text" class="form-control visually-hidden" name="LogSuperID" id="LogSuperID" value="<?php echo $pan_id; ?>">
                        </div>
                        <div class="col-md-3">
                           <button type="submit" style="margin-top: 35px;" name="addnew_ip" class="form-control btn btn-primary ">ADD IP</button>
                        </div>
                     </form>
                  </div>
               </div>
         ...
         <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">All Proxy List</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <div class="card-body">
