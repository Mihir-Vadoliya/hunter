                                            ...
                                            <button class="nav-link active bg-transparent" id="allid-tab" data-toggle="tab" data-target="#allid" type="button" role="tab" aria-controls="allid" aria-selected="true"><strong class="text-light">
                                                    <h4 class="m-0 font-weight-bold text-dark">
                                                        <font size="+2">Today Result:
                                                            ...
                                                            $querytores = "SELECT * FROM `u952853138_Hunterits`.`tickets` where UserID in (SELECT user_id FROM details where agent_user in (Select p_id from userinfo where super_id in (Select sn from super where sub_admin_id = '$admin_name')))";
                                                            ...
                                                            <div class="table-responsive">
                                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        $query = "SELECT * FROM `u952853138_Hunterits`.`tickets` where UserID in (SELECT user_id FROM details where agent_user in (Select p_id from userinfo where super_id in (Select sn from super where sub_admin_id = '$admin_name')))";
                                                            ...
                                                            <div class="table-responsive">
                                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        $todaydate =  date('Y-m-d');
                                                                        $querytotaloutcomes = "SELECT * FROM `u952853138_Hunterits`.`tickets` where UserID in (SELECT user_id FROM details where agent_user in (Select p_id from userinfo where super_id in (Select sn from super where sub_admin_id = '$admin_name')))";
