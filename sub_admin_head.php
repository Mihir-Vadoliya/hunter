...
if (isset($_SESSION['subid'])) {
    $testforwel = strtoupper("<small> WELCOME TO YOUR SUB ADMIN PRICE 600 DASHBOARD.</small>");
}

if (isset($_SESSION['subid'])) {
    $subadmin_name =  $_SESSION['subid'];
    $todaydate = date('Y-m-d h:i:sa');
    $queryres = "SELECT * FROM sub_admin where 	san = '$subadmin_name'";
...
<head>
    ...
    <title>Hunter | <?php echo $subadminname; ?></title>
