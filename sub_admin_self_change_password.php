...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "UPDATE sub_admin SET password='$pass' WHERE  san=$sn AND sub_admin_id='$id' ";

   if ($con->query($sql) === TRUE) {
      $_SESSION['success'] = 'Super Password Change Successfully';
      header('location:subadmin_dashboard.php');
?><script>
         window.location = 'subadmin_dashboard.php';
      </script>
<?php
      exit;
   } else {
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Mini Admin Change Password</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                        ...
                        <div class="row">
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
                                 <label for="clientid" class="form-label mt-4">MINI ADMIN NAME</label>
                                 <input type="text" class="form-control" name="id" id="clientid" readonly="readonly" value="<?php echo $_SESSION['info']['sub_admin_id'] ?>" aria-describedby="clientid" required placeholder="CLIENT ID">
                                 <input type="hidden" class="form-control" name="sn" id="clientid" value="<?php echo $_SESSION['info']['san'] ?>" aria-describedby="clientid" required placeholder="CLIENT ID">
                              </div>
                           </div>
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
