            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Master Admin Password Change</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                        ...
                        <div class="row">
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="id" id="clientid" readonly="readonly" value=<?php echo $_SESSION['info']['admin_id'] ?> aria-describedby="clientid" required placeholder="CLIENT ID">
                                 <input type="hidden" class="form-control" name="sn" id="clientid" value=<?php echo $_SESSION['info']['an'] ?> aria-describedby="clientid" required placeholder="CLIENT ID">
                              </div>
                           </div>
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
