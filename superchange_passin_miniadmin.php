...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "UPDATE super SET password='$pass' WHERE  sn=$sn AND s_id='$id' ";

   if ($con->query($sql) === TRUE) {
      $_SESSION['success'] = 'Password Change Successfully';
      header('location:miniadmin_superlist.php?id=PASSWORD CHANGED SUCCESSFULLY!');
?><script>
         window.location = 'miniadmin_superlist.php';
      </script>
<?php
      exit;
   } else {
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Super Password Change</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
