...
<div class="content-wrapper">
   ...
   <!-- /.content-header -->
   <?PHP
   $queryactive = "SELECT * FROM details where activated = 0";
   $resultactive = $con->query($queryactive);
   $totalactivesubadmin = mysqli_num_rows($resultactive);

   $querydeactive = "SELECT * FROM details where activated = 1";
                              ...
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link bg-transparent" id="todayid-tab" data-toggle="tab" data-target="#todayid" type="button" role="tab" aria-controls="todayid" aria-selected="false">
                                    <strong class="text-light"> Today Create ID:
                                       ...
                                       $querytores = "SELECT * FROM `details`";
                              ...
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link bg-transparent" id="paidid-tab" data-toggle="tab" data-target="#paidid" type="button" role="tab" aria-controls="paidid" aria-selected="false">
                                    <strong class="text-light"> Paid ID:
                                       <?php
                                       $querypaid = "SELECT * FROM details where admin_pay = 1";
                              ...
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link bg-transparent" id="unpaidid-tab" data-toggle="tab" data-target="#unpaidid" type="button" role="tab" aria-controls="unpaidid" aria-selected="false">
                                    <strong class="text-light"> Unpaid ID:
                                       <?php
                                       $queryunpaid = "SELECT * FROM details where admin_pay = 0";
                              ...
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link bg-transparent" id="monthid-tab" data-toggle="tab" data-target="#monthid" type="button" role="tab" aria-controls="monthid" aria-selected="false">
                                    <strong class="text-light"> This Month ID:
                                       ...
                                       include('database/config.php');
                                       $monthid = date('m');
                                       $querytomonth = "SELECT * FROM `details`";
                                                   ...
                                                   <tbody>
                                                      ...
                                                      ?>
                                                            <tr>
                                                               ...
                                                               <td>
                                                                  <?php $masteradminid = "Select mini_admin_id from mini_admin where mini_id in (select mini_admin_id from sub_admin where san in (select sub_admin_id from super where sn in (select super_id from userinfo where p_id in (select agent_user from details where sn = '$sn')))) ";
                                                               ...
                                                               <td>
                                                                  <?php $miniid = "SELECT * FROM sub_admin where san in (SELECT sub_admin_id  FROM super where sn in (SELECT super_id FROM userinfo where p_id in (SELECT agent_user FROM details where  sn='$sn')))";
                                                               ...
                                                               <td><?php echo $k ?></td>
                                                               <td><a onclick="return chcekcreate();" href="admin_delete.php?sn=<?php echo $sn ?>&id=<?php echo $user_id ?>">Delete ID</a></td>
                                                               <td><a href="/admin_seller_extenddays.php?id=<?php echo $sn; ?>">Extend ID</a></td>
                                                               ...
                                                               <td>
                                                                  ...
                                                                  if ($admin_payment == 0) {
                                                                  ?>
                                                                     <a href="admin_id.php?changepaymentstatus=true&id=<?php echo $sn; ?>" class="text-danger pl-4 pr-3">Unpaid</a>
                                                                  <?php
                                                                  } else {
                                                                  ?>
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      <?php
                                                      $name = $_SESSION['info']['username'];
                                                      $sqlactive = "SELECT * FROM details where activated = 0 ";
                                                      ...
                                                      if ($resultactive->num_rows > 0) {
                                                         ...
                                                         while ($rowactive = $resultactive->fetch_assoc()) {
                                                            ...
                                                            $days = 1;
                                                            $deactivated = $rowactive["activated"];
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqldeactive = "SELECT * FROM details where activated = 1 ";
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqltodayid = "SELECT * FROM details where DATE(registration) = '$todaydate'  ";
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqlpaidid = "SELECT * FROM details where admin_pay = 1 ";
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sql = "SELECT * FROM details where admin_pay = 0";
                                                      $result = $con->query($sql);
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      include('database/config.php');
                                                      $monthidfor = date('m');
                                                      $querytomonthfor = "SELECT * FROM `details`";
                                                      ...
                                                      ?>
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     <?php
                                                                     $miniid = "SELECT * FROM sub_admin where san in (SELECT sub_admin_id  FROM super where sn in (SELECT super_id FROM userinfo where p_id in (SELECT agent_user FROM details where  sn=' $usermonthsn')))";
                                                                     $miniadminresult = $con->query($miniid);
                                                                     $miniadminrow = $miniadminresult->fetch_assoc();
                                                                     echo $miniadminrow['sub_admin_id'];
                                                                     ?>
                                                                  ...
                                                                  <td <?php echo $m ?>><?php echo $days; ?> </td>
                                                                  <td><?php echo $k ?></td>
                                                                  <td><a onclick="return chcekcreate();" href="admin_delete.php?sn=<?php echo $usermonthsn ?>&id=<?php echo $user_idmonthid ?>">Delete ID</a></td>
                                                                  <td>
                                                                     <?php
                                                                     if ($admin_payment == 0) {
                                                                     ?>
                                                                        <a href="admin_id.php?changepaymentstatus=true&id=<?php echo $usermonthsn; ?>" class="text-danger pl-4 pr-3">Unpaid</a>
                                                                     <?php
                                                                     } else {
                                                                     ?>
                                                                        <p class=" text-success"><strong>Paid</strong></p>
                                             ...
                                             <div class="table-responsive">
                                                <table data-page-length='25' class="table table-hover table-bordered border-primary table-md display" id="" width="100%" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqltodayid = "SELECT * FROM details where DATE(expiry_date) < '$todaydate' ";
                                                      $resulttodayid = $con->query($sqltodayid);
