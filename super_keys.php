...
if (isset($_SESSION['superid'])) {
    ...
    $queryres = "SELECT * FROM details where agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row my-2">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <?php
                                    $queryactive = "SELECT * FROM details where activated = 0 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                    $resultactive = $con->query($queryactive);
                                    $totalactivesubadmin = mysqli_num_rows($resultactive);
                                    
                                    $querydeactive = "SELECT * FROM details where activated = 1 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                    $resultdeactive = $con->query($querydeactive);
                                    $totaldeactivesubadmin = mysqli_num_rows($resultdeactive);
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" style="background:#222d32;" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active bg-transparent" id="allid-tab"
                                                data-toggle="tab" data-target="#allid" type="button" role="tab"
                                                aria-controls="allid" aria-selected="true"><strong class="text-light">
                                                    Total ID: <?php echo $totalsubadmin; ?></strong> </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="activeid-tab" data-toggle="tab"
                                                data-target="#activeid" type="button" role="tab"
                                                aria-controls="activeid" aria-selected="false"><strong
                                                    class="text-light"> Activate ID: <?php echo $totalactivesubadmin; ?></strong>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="deactivid-tab" data-toggle="tab"
                                                data-target="#deactivid" type="button" role="tab"
                                                aria-controls="deactivid" aria-selected="false"><strong
                                                    class="text-light"> Deactivate ID: <?php echo $totaldeactivesubadmin; ?></strong>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="todayid-tab" data-toggle="tab"
                                                data-target="#todayid" type="button" role="tab"
                                                aria-controls="todayid" aria-selected="false">
                                                <strong class="text-light"> Today Create ID:
                                                    <?php
                                                    include 'database/config.php';
                                                    $todaydate = date('Y-m-d');
                                                    $querytores = "SELECT * FROM details where agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="paidid-tab" data-toggle="tab"
                                                data-target="#paidid" type="button" role="tab"
                                                aria-controls="paidid" aria-selected="false">
                                                <strong class="text-light"> Paid ID:
                                                    <?php
                                                    $querypaid = "SELECT * FROM details where admin_pay = 1 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="unpaidid-tab" data-toggle="tab"
                                                data-target="#unpaidid" type="button" role="tab"
                                                aria-controls="unpaidid" aria-selected="false">
                                                <strong class="text-light"> Unpaid ID:
                                                    <?php
                                                    $queryunpaid = "SELECT * FROM details where admin_pay = 0 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="monthid-tab" data-toggle="tab"
                                                data-target="#monthid" type="button" role="tab"
                                                aria-controls="monthid" aria-selected="false">
                                                <strong class="text-light"> This Month ID:
                                                    <?php
                                                    include 'database/config.php';
                                                    $monthid = date('m');
                                                    $querytomonth = "SELECT * FROM details where agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link bg-transparent" id="expiredid-tab"
                                                data-toggle="tab" data-target="#expiredid" type="button"
                                                role="tab" aria-controls="expiredid" aria-selected="false">
                                                <strong class="text-light"> Expired ID:
                                                    <?php
                                                    include 'database/config.php';
                                                    $monthid = date('m');
                                                    $querytomonth = "SELECT * FROM details where DATE(expiry_date) < '$todaydate' and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                                    $resulttomonth = mysqli_query($con, $querytomonth);
                                                    $counttomonth = mysqli_num_rows($resulttomonth);
                                                    echo $counttomonth;
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="allid" role="tabpanel"
                                            aria-labelledby="allid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                        <div class="card-header py-1"
                                                            style="background-image:linear-gradient(180deg,#009688 10%,#009688 100%)">
                                                            <h4 class="text-light"><strong>All ID:
                                                                    <?php echo $totalsubadmin; ?></strong></h4>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table data-page-length='25'
                                                                    class="table table-hover table-bordered border-primary table-md display"
                                                                    id="" width="100%" cellspacing="0">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>SERIAL No.</th>
                                                                            <th>KEY</th>
                                                      ...
                                                      $sql = "SELECT * FROM details where agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                                      ...
                                                      if ($result->num_rows > 0) {
                                                         ...
                                                         while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($mac === "not_registered") {
                                                               ...
                                                               $reset_url = 'super_masterreset_mac.php?sn=' . $sn . '&id=' . $user_id;
                                                            }
                                                            ...
                                                            $subadmincredit = "Select * from `super` where `sn` ='$admin_name' ";
                                                            ...
                                                            $superpaymentcredit = "UPDATE `super` SET `payment`='$newcreditsubadmin' WHERE `sn`='$admin_name'";
                                                            ...
                                                            if (isset($_GET['changepaymentstatussuper'])) {
                                                               $super_id = $_GET['id'];
                                                               $todate = date('Y-m-d h:i:sa');
                                                               $supercredit = "Select * from `super` where `sn` ='$admin_name' ";
                                                                   $resultcredit = $con->query($supercredit);
                                                                   while ($rowcredit = $resultcredit->fetch_assoc()) {
                                                                        $credit = $rowcredit["payment"];
                                                                    }
                                                                    if($credit > 0){
                                                                         $newcredit =  $credit -1; 
                                                                          $superpaymentcredit = "UPDATE `super` SET `payment`='$newcredit' WHERE `sn`='$admin_name'";
                                                      ...
                                                      ?>
                                                                        <tr>
                                                                            ...
                                                                            <td align="center"><a
                                                                                    href="<?php echo $reset_url; ?>"><?php echo $show; ?></a>
                                                                            </td>
                                                                            ...
                                                                            if ($admin_payment == 0) {
                                                                            ?>
                                                                            <a href="super_keys.php?changepaymentstatus=true&id=<?php echo $sn  ?>" class="text-danger">Unpaid</a>
                                                                            <?php
                                                                            } else {
                                                                            ?>
                                        ...
                                        <div class="tab-pane fade" id="activeid" role="tabpanel"
                                            ...
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <div class="card shadow mb-4">
                                                        <div class="card-header py-1"
                                                            style="background-image:linear-gradient(180deg,#009688 10%,#009688 100%)">
                                                            <h4 class="text-light"><strong>Activate ID:
                                                                    <?php echo $totalactivesubadmin; ?></strong></h4>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table data-page-length='25'
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqlactive = "SELECT * FROM details where activated = 0 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <div class="tab-pane fade" id="deactivid" role="tabpanel"
                                            aria-labelledby="deactivid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <div class="card shadow mb-4">
                                                        <div class="card-header py-1"
                                                            style="background-image:linear-gradient(180deg,#009688 10%,#009688 100%)">
                                                            <h4 class="text-light"><strong>Deactivate ID:
                                                                    <?php echo $totaldeactivesubadmin; ?></strong></h4>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table data-page-length='25'
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqldeactive = "SELECT * FROM details where activated = 1 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <div class="tab-pane fade" id="todayid" role="tabpanel"
                                            aria-labelledby="todayid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                        <div class="card-header py-1"
                                                            ...
                                                            <h4 class="text-light">
                                                                <strong> Today Create ID:
                                                                    ...
                                                                    include 'database/config.php';
                                                                    $todaydate = date('Y-m-d');
                                                                    $querytores = "SELECT * FROM details where DATE(registration) = '$todaydate' and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                                                    $resulttores = mysqli_query($con, $querytores);
                                                                    $counttores = mysqli_num_rows($resulttores);
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqltodayid = "SELECT * FROM details where DATE(registration) = '$todaydate' and agent_user in (Select p_id from userinfo where super_id  = '$admin_name')";
                                        ...
                                        <div class="tab-pane fade" id="paidid" role="tabpanel"
                                            aria-labelledby="paidid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqlpaidid = "SELECT * FROM details where admin_pay = 1 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                        ...
                                        <div class="tab-pane fade" id="unpaidid" role="tabpanel"
                                            aria-labelledby="unpaidid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sql = "SELECT * FROM details where admin_pay = 0 and agent_user in (Select p_id from userinfo where super_id  = '$admin_name') ";
                                                      $result = $con->query($sql);
                                        ...
                                        <div class="tab-pane fade" id="monthid" role="tabpanel"
                                            aria-labelledby="monthid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                      ...
                                                      include('database/config.php');
                                                      $monthidfor = date('m');
                                                      $querytomonthfor = "SELECT * FROM details where agent_user in (Select p_id from userinfo where super_id  = '$admin_name')";
                                        ...
                                        <div class="tab-pane fade" id="expiredid" role="tabpanel"
                                            aria-labelledby="expiredid-tab">
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <!-- DataTales Example -->
                                                    <div class="card shadow mb-4">
                                                      ...
                                                      $name = $_SESSION['info']['username'];
                                                      $sqltodayid = "SELECT * FROM details where  DATE(expiry_date) < '$todaydate' and agent_user in (Select p_id from userinfo where super_id  = '$admin_name')";
                                                      $resulttodayid = $con->query($sqltodayid);
