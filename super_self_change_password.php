                        ...
                        <div class="row">
                           <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="id" id="clientid" readonly="readonly" value="<?php echo $_SESSION['info']['s_id'] ?>" aria-describedby="clientid" required placeholder="CLIENT ID">
